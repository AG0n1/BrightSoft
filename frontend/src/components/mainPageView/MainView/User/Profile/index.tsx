...
const Profile = () => {
    ...
    const handleRedirect = () => {
        setIsModalOpen(true);
        navigate({
            pathname: routeGenerator(Routes.mainPage, Routes.profile, Routes.devices)
        })
    }
        ...
        <main className={s.mainProfile}>
            ...
            <section className={s.personalInfo}>
                ...
                >
                    ...
                    >
                        {
                            disabled ? userInfo?.secondName : <Input placeholder={userInfo?.secondName} />
                        }
                    </FormItem>
                    <FormItem
                        label={'Имя'}
                    ...
                    >
                        {
                            disabled ? userInfo?.fatherName : <Input placeholder={userInfo?.fatherName} />
                        }
                    </FormItem>
                    <FormItem
                    ...
                    <FormItem
                        ...
                        name={'devices'}
                    >
                        <Button disabled={false} type={'default'} onClick={handleRedirect}>Посмотреть устройства</Button>
                    </FormItem>
                    {
                        !disabled &&
